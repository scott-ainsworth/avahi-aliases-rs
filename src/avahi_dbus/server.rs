...
pub trait OrgFreedesktopAvahiServer2 {
    fn get_version_string(&self) -> Result<String, dbus::Error>;
    fn get_apiversion(&self) -> Result<u32, dbus::Error>;
    fn get_host_name(&self) -> Result<String, dbus::Error>;
    fn set_host_name(&self, name: &str) -> Result<(), dbus::Error>;
...
#[derive(Debug)]
pub struct OrgFreedesktopAvahiServer2StateChanged {
    pub state: i32,
    pub error: String,
}

impl arg::AppendAll for OrgFreedesktopAvahiServer2StateChanged {
    fn append(&self, i: &mut arg::IterAppend<'_>) {
        arg::RefArg::append(&self.state, i);
        arg::RefArg::append(&self.error, i);
    }
...
impl arg::ReadAll for OrgFreedesktopAvahiServer2StateChanged {
    fn read(i: &mut arg::Iter<'_>) -> Result<Self, arg::TypeMismatchError> {
        Ok(OrgFreedesktopAvahiServer2StateChanged { state: i.read()?, error: i.read()? })
    }
}

impl dbus::message::SignalArgs for OrgFreedesktopAvahiServer2StateChanged {
    const NAME: &'static str = "StateChanged";
    const INTERFACE: &'static str = "org.freedesktop.Avahi.Server2";
}

impl<'a, T: blocking::BlockingSender, C: ::std::ops::Deref<Target = T>>
    OrgFreedesktopAvahiServer2 for blocking::Proxy<'a, C>
{
    fn get_version_string(&self) -> Result<String, dbus::Error> {
        self.method_call("org.freedesktop.Avahi.Server2", "GetVersionString", ())
            .and_then(|r: (String,)| Ok(r.0))
    }

    fn get_apiversion(&self) -> Result<u32, dbus::Error> {
        self.method_call("org.freedesktop.Avahi.Server2", "GetAPIVersion", ())
            .and_then(|r: (u32,)| Ok(r.0))
    }

    fn get_host_name(&self) -> Result<String, dbus::Error> {
        self.method_call("org.freedesktop.Avahi.Server2", "GetHostName", ())
            .and_then(|r: (String,)| Ok(r.0))
    }

    fn set_host_name(&self, name: &str) -> Result<(), dbus::Error> {
        self.method_call("org.freedesktop.Avahi.Server2", "SetHostName", (name,))
    }

    fn get_host_name_fqdn(&self) -> Result<String, dbus::Error> {
        self.method_call("org.freedesktop.Avahi.Server2", "GetHostNameFqdn", ())
            .and_then(|r: (String,)| Ok(r.0))
    }

    fn get_domain_name(&self) -> Result<String, dbus::Error> {
        self.method_call("org.freedesktop.Avahi.Server2", "GetDomainName", ())
            .and_then(|r: (String,)| Ok(r.0))
    }

    fn is_nsssupport_available(&self) -> Result<bool, dbus::Error> {
        self.method_call("org.freedesktop.Avahi.Server2", "IsNSSSupportAvailable", ())
            .and_then(|r: (bool,)| Ok(r.0))
    }

    fn get_state(&self) -> Result<i32, dbus::Error> {
        self.method_call("org.freedesktop.Avahi.Server2", "GetState", ())
            .and_then(|r: (i32,)| Ok(r.0))
    }

    fn get_local_service_cookie(&self) -> Result<u32, dbus::Error> {
        self.method_call("org.freedesktop.Avahi.Server2", "GetLocalServiceCookie", ())
            .and_then(|r: (u32,)| Ok(r.0))
    }

    fn get_alternative_host_name(&self, name: &str) -> Result<String, dbus::Error> {
        self.method_call("org.freedesktop.Avahi.Server2", "GetAlternativeHostName", (name,))
            .and_then(|r: (String,)| Ok(r.0))
    }

    fn get_alternative_service_name(&self, name: &str) -> Result<String, dbus::Error> {
        self.method_call("org.freedesktop.Avahi.Server2", "GetAlternativeServiceName", (name,))
            .and_then(|r: (String,)| Ok(r.0))
    }
    ...
    fn entry_group_new(&self) -> Result<dbus::Path<'static>, dbus::Error> {
        self.method_call("org.freedesktop.Avahi.Server2", "EntryGroupNew", ())
            .and_then(|r: (dbus::Path<'static>,)| Ok(r.0))
    }
